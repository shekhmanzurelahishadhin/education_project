            ...
            <div class="row">
                <div class="col-lg-3 col-md-12 col-sm-12 footer-widget md-mb-50">
                    ...
                    <ul class="footer_social">
                        <li>
                            <a href="{{$links->facebook}}" target="_blank"><span><i class="fa fa-facebook"></i></span></a>
                        </li>
                        <li>
                            <a href="{{$links->youtube}} " target="_blank"><span><i class="fa fa-youtube-play"></i></span></a>
                        </li>

                        <li>
                            <a href="{{$links->instagram}}" target="_blank"><span><i class="fa fa-instagram"></i></span></a>
                        </li>
                        <li>
                            <a href="{{$links->linkedIn}}" target="_blank"><span><i class="fa fa-linkedin"></i></span></a>
                        </li>
