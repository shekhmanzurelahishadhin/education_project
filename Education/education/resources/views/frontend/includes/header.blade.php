                                                ...
                                                @endforeach
                                                 <li class="menu-item">
                                                    <a href="/managing/committe">
                                                         @if(session()->get('language') == 'bangla') নির্বাহী সমিতি @else Managing Committee @endif</a>
                                                </li>
                                                    <li class="menu-item">
...
{{--                                        </li>--}}
                                        <li class="menu-item-has-children">
                                            <a href="#">
                                                @if(session()->get('language') == 'bangla') সেবাসমূহ @else Services @endif  </a>
                                            <ul class="sub-menu">
                                                <li class="menu-item">
                                        ...
                                        <li class="menu-item {{Request::routeIs('contacts') ? 'current-menu-item' : ''}}">
                                            <a href="{{route('certificate.verify')}}">
                                                @if(session()->get('language') == 'bangla') সার্টিফিকেট যাচাই @else Certificate Verify @endif
                                            </a>
                                        </li>
                                        <li class="menu-item {{Request::routeIs('contacts') ? 'current-menu-item' : ''}}">
